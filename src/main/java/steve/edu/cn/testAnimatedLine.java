...
public class testAnimatedLine extends Application {
...
//    }
    ...
    private void addDataToSeries() {
        series1.getData().add(new XYChart.Data<>(xSeriesData, 1));
        series2.getData().add(new XYChart.Data<>(xSeriesData, 2));
        series3.getData().add(new XYChart.Data<>(xSeriesData, 3));
        xSeriesData++;
